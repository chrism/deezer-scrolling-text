...
define('deezer-scrolling-text/tests/app.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('components/item-display.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/item-display.js should pass ESLint\n\n');
  });
...
define('deezer-scrolling-text/tests/helpers/ember-cli-clipboard', ['exports'], function (exports) {
  'use strict';
...
define('deezer-scrolling-text/tests/integration/components/item-display-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | item-display', function (hooks) {
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "9Eb0sbTE",
        "block": "{\"symbols\":[],\"statements\":[[1,[20,\"item-display\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "aKRM7yWg",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"item-display\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('deezer-scrolling-text/tests/test-helper', ['deezer-scrolling-text/app', 'deezer-scrolling-text/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
define('deezer-scrolling-text/tests/tests.lint-test', [], function () {
  'use strict';

  QUnit.module('ESLint | tests');

  QUnit.test('integration/components/item-display-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/item-display-test.js should pass ESLint\n\n');
  });
...
require('deezer-scrolling-text/tests/test-helper');
